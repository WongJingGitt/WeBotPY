...
from webot.databases.database_type import MemoryEventType
...
class SendMentionsMessageInput(BaseModel):
    ...
    at_users_wxid: List[str] = Field(default=[], description="要@的人的wxid列表，当需要提及所有人时传递`notify@all`。例如：[\"wxid_abcdefg123456\", \"wxid_abcdefg123456\"]、[\"notify@all\"]。")
